...
class ColorController extends Controller
{
   ...
   *                 property="colors",
   *                 type="array",
   *                 description="List of colors to add",
   *                 @OA\Items(
   *                     type="object",
   *                     required={"Name", "Quantity"},
   *                     @OA\Property(property="Name", type="string", example="red-test"),
   ...
   *                 property="data",
   *                 type="array",
   *                 description="List of added colors",
   *                 @OA\Items(
   *                     type="object",
   *                     @OA\Property(property="CatalogId", type="integer", example=18),
   *                     @OA\Property(property="Name", type="string", example="red-test"),
   *                     @OA\Property(property="Quantity", type="number", format="float", example=200),
   ...
   *                 property="data",
   *                 type="array",
   *                 description="List of colors with their quantities to update",
   *                 @OA\Items(
   *                     type="object",
   ...
   *                 property="data",
   *                 type="array",
   *                 description="List of updated colors",
   *                 @OA\Items(
   *                     type="object",
   *                     @OA\Property(property="Id", type="integer", example=26),
   *                     @OA\Property(property="CatalogId", type="integer", example=18),
   *                     @OA\Property(property="Name", type="string", example="red-test"),
   *                     @OA\Property(property="Quantity", type="integer", example=220)
   *                 )
   *             )
   *         )
   *     ),
